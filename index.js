...
//The nested function can access the variable 'internal' because it is a child of its parent function 'myFunction'. Therefore, 'internal' is within the nested function's scope and can be used.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const newValue = array.reduce(function(total,item){
